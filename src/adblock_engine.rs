...
impl AdblockEngineManager {
    ...
    pub fn get_ublock_core_rules() -> Vec<String> {
        vec![
            ...
            "youtube.com##ytd-enforcement-message-view-model".into(),
            "youtube.com##tp-yt-paper-dialog:has(ytd-enforcement-message-view-model)".into(),
            "youtube.com##tp-yt-paper-dialog:has(#feedback.ytd-enforcement-message-view-model)".into(),
            "youtube.com##tp-yt-iron-overlay-backdrop.opened".into(),
            "youtube.com##iron-overlay-backdrop.opened".into(),
