...
(function () {
  ...
  function renderTabs() {
    ...
    state.tabs.forEach((tab) => {
      ...
      } else if (tab.url.startsWith('titan://settings') || tab.url.startsWith('titan://themes') || tab.url.startsWith('titan://privacy') || tab.url.startsWith('titan://adblock') || tab.url.startsWith('titan://shields')) {
